...
const Remark = tw.span`bg-green-200 text-green-900 p-1 rounded m-1`;

export const MainQuote = () => {
  return (
    <div tw="text-center px-2 md:px-36">
      <h3 tw="text-6xl font-bold">"Love Code" is the way we roll</h3>
      <p tw="text-xl md:text-3xl my-10 text-gray-500 leading-loose md:leading-loose">
